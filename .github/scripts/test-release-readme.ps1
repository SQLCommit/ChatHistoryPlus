...
$fixture = @'
<div align="center">
# ![ChatHistoryPlus](https://readme-typing-svg.demolab.com/?lines=ChatHistoryPlus)
...
| `/chathistoryplus limit <rate>` | `/ashita/<Name>_<id>/` |
...
foreach ($expected in @(
    '# ChatHistoryPlus', '## Features', '### Cutscenes', 'Keep this summary.',
...
$scratch = Join-Path ([IO.Path]::GetTempPath()) ('chathistoryplus-release-test-' + [guid]::NewGuid().ToString('N'))
